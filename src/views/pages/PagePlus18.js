...
import back_image from './../../assets/img/adult.jpg';
...
export default function Bollywood() {
    ...
    const loadData = (timestamp) => {
        let filters = {industry: Industry.PLUS18};
                        ...
                        <Grid item md={6}>
                            <div className={classes.mainFeaturedPostContent}>
                                ...
                                <Typography variant="h5" color="inherit" paragraph>
                                    We all like adult movies for entertainment. We bring quality videos for you because quality matters.
                                </Typography>
                            </div>
                        </Grid>
                    </Grid>
                ...
                {latest ? (
                    <Container className={classes.cardGrid} maxWidth="md">
                        <Grid container spacing={4}>
                            {latest.map((card) => (
                                <MediaCard card={card} industry={Industry.PLUS18}/>
                            ))}
                        </Grid>
